...
function Partida(num,owner,codigo){
	...
	this.quitarAlMasVotado=function(){
		this.usuarios[this.recuentoMasVotado().nick].estado = new Muerto();
	...
	this.comprobarFinalVotacion=function(){
